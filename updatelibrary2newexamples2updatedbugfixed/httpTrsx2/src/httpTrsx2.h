...
#define HTTPTRSX2_H
	...
	//#define SOCKET_DEBUG
	#define HTTPTRSX_MIN_INTERVAL_MS 500//ms
	...
	#define EM_RUN_REPETITIVE       ((HTTP_TRSX_SET_EXEC_MODE){EM_RUN_REPETITIVE_E})
	...
	enum HTTPTRSX_TYPEDATA{
		TX_CHARARRAY = 0,
		TX_JSONSTRUCT,
	};
	int8_t httpTrsx_job(TRSX *trsx, int8_t typeData, void *txmsg, uint16_t txmsgSize, char *rxmsg, uint16_t rxmsgSize, uint16_t *rxCounterChar);
